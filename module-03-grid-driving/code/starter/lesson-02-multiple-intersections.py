...
# TODO: Clear the intersection (drive forward briefly)
# tracker.drivetrain.set_effort(0.3, 0.3)
# time.sleep(0.3)

# TODO: Drive to the second intersection
# tracker.track_until_cross()

# TODO: Rewrite the above using a for loop to drive N intersections
# intersections = 3
...
# TODO (bonus): Create a drive_intersections(tracker, count) function
