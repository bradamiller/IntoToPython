# Lesson 5 Slide Outline (Optional Extension): The Completed Dijkstra Class

> **Optional Extension deck.** Lesson 5's primary content is now taught with plain functions -- see `05-implementing-compute-dijkstra-path-outline.md`. This deck completes the `Dijkstra` class from the Lesson 4 Optional Extension, for courses that also cover OOP.

## Slide 1: Title & Learning Objectives
**Title:** Optional Extension -- The Completed Dijkstra Class
