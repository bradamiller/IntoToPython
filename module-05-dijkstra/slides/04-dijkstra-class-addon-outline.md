# Lesson 4 Slide Outline (Optional Extension): The Dijkstra Class

> **Optional Extension deck.** Lesson 4's primary content is now taught with plain functions -- see `04-the-dijkstra-functions-outline.md`. This deck is the supplementary "package it as a class" presentation for courses that also cover OOP.

## Slide 1: Title & Learning Objectives
**Title:** Optional Extension -- The Dijkstra Class
