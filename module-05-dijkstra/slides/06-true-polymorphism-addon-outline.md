# Lesson 6 Slide Outline (Optional Extension): True Polymorphism with Classes

> **Optional Extension deck.** Lesson 6's primary content is now taught with a `compute_path(algorithm, ...)` dispatch function over plain functions -- see `06-testing-and-swapping-outline.md`. This deck shows the classes alternative: identical method signatures give true polymorphism, no dispatch function needed, for courses that also cover OOP.

## Slide 1: Title & Learning Objectives
**Title:** Optional Extension -- True Polymorphism with Classes
