# Lesson 5 Slide Outline (Optional Extension): Implementing the Manhattan Class

> **Optional Extension deck.** Lesson 5's primary content is now taught with a plain function -- see `05-a-reusable-manhattan-function-outline.md`. This deck is the supplementary "refactor into a class" presentation for courses that also cover OOP.
